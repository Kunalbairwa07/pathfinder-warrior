  ...
  return <div className="min-h-screen bg-background text-foreground flex flex-col">
      <header className="border-b border-border bg-card shadow-lg">
        <div className="container mx-auto px-6 py-4">
          ...
          <p className="text-sm text-muted-foreground mt-1">Made By Kunal Bairwa (Team Warrior)</p>
        </div>
      </header>
        ...
        <div className="border-b border-border bg-card/50">
          <div className="container mx-auto px-6">
            <TabsList className="h-14 bg-transparent">
              <TabsTrigger value="classic" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2">
